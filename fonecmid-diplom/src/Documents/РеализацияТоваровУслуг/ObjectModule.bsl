...
Процедура ВыполнитьАвтозаполнение() Экспорт
	...
	ДанныеДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, "ВКМ_СуммаАбонентскойПлаты, ВКМ_Дата, ВКМ_СрокДействия");

	
	Если ДанныеДоговора.ВКМ_СуммаАбонентскойПлаты > 0 И ДанныеДоговора.ВКМ_Дата <= НачалоМесяца(Дата) И ДанныеДоговора.ВКМ_СрокДействия >= КонецМесяца(Дата) Тогда
